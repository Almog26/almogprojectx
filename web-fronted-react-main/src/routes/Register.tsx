  ...
  const onRegister = (data: RegisterUser) => {
    auth
      ...
      .then((res) => {
        ...
        dialogs.showSuccessDialog("Success", "Register").then(() => {
          navigate("/login");
        });
      })
      .catch((e) => {
        dialogs.showErrorDialog("Error", e.response.data);
      });
  };

  return (
    <div className={`register-container ${theme === "light" ? "bg-gray-100" : "bg-gray-800"}`}>
